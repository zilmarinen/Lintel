...
```swift
.package(url: "https://github.com/zilmarinen/Lintel.git", .upToNextMinor(from: "0.1.0")),
```
...
The Lintel framework is primarily the work of [Zack Brown](https://github.com/zilmarinen).
